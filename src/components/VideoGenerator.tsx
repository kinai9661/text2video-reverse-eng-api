        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 border border-gray-300 rounded-lg min-h-[120px] focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-3.5 rounded-lg disabled:opacity-50 hover:shadow-xl transition"
          >
            {loading ? '⏳ 生成中...' : '🎬 生成影片'}
          </button>

          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg text-xs">
            <p className="font-semibold text-blue-900 mb-1.5">🔍 自動檢測工具</p>
            <p className="text-blue-800 mb-2">遇到 404？找出正確的模型名稱:</p>
            <code className="block bg-white px-3 py-2 rounded border border-blue-200 text-blue-900">
              npm run detect
            </code>
          </div>
        </div>
      ...
      <div className="bg-white/95 backdrop-blur rounded-xl p-6 shadow-2xl">
        ...
        {videoUrl ? (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button 
                ...
                className="flex items-center justify-center gap-2 bg-purple-600 text-white px-4 py-2.5 rounded-lg hover:bg-purple-700 font-medium"
              >
                <Download size={18} />下載
              </button>
              <button 
                ...
                className="flex items-center justify-center gap-2 border-2 border-gray-300 px-4 py-2.5 rounded-lg hover:bg-gray-50 font-medium"
              >
                <Copy size={18} />複製
              </button>
            </div>
          ...
          <div className="text-center py-24">
            ...
            <p className="font-semibold text-gray-700 text-lg">生成中...</p>
            {taskId && <p className="text-xs text-gray-500 mt-2">ID: {taskId.substring(0, 16)}...</p>}
          </div>
        ) : (
